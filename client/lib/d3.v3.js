d3 = function () {
    ...
    var d3_svg_symbols = d3.map({
        ...
        "CrossStreetFullClick": function (size) {
            var r = Math.sqrt(size);
            console.log(size)
            return "M" + -r + "," + -r
                + "L" + r + "," + -r
        ...
        "Culvert": function (size) {
            var r = Math.sqrt(size) / 1.5;
            console.log(size)
            return "M" + -r + "," + -r
                + "L" + -3 * r / 4 + "," + -r
                + "M" + -2 * r / 4 + "," + -r
        ...
        "RightStreetFullClick": function (size) {
            var r = Math.sqrt(size);
            console.log(size)
            return "M" + -r + "," + -r
                + "L" + r + "," + -r
        ...
        "LeftStreetFullClick": function (size) {
            var r = Math.sqrt(size);
            console.log(size)
            return "M" + -r + "," + -r
                + "L" + r + "," + -r
        ...
        "BridgeBegin": function (size) {
            var r = Math.sqrt(size) / 1.8;
        ...
        "Ramp": function (size) {
            var rx = Math.sqrt(size / (1 * d3_svg_symbolTan30)),
                ry = rx * d3_svg_symbolTan30;
            return "M0," + -ry
                + "L" + rx + ",0"
                + " 0," + ry
                + " " + -rx + ",0"
